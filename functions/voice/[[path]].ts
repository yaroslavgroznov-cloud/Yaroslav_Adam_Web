// Cloudflare Pages Function — reverse-proxy для /voice/*.
// Та же логика что в /adam/*, /admin/*, /family/*, /files/*.
// Sprint F.15, 2026-05-26.
...
export const onRequest: PagesFunction<Env> = async ({ request, env, params, next }) => {
  ...
  const targetUrl = `${BACKEND_BASE}/voice/${path}${url.search}`;
